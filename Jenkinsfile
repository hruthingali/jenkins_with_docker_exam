    ...
    stages {
        stage('Checkout Code') {
            steps {
                ...
                git url: 'https://github.com/jkbarathkumar/jenkins_with_docker', branch: 'main'  // Replace with your actual GitHub repo and branch
            }
        }
        ...
        stage('Run Tests on Docker Image') {
            steps {
                script {
                    // Run tests using the Docker image pulled from Docker Hub
